$(document).ready(function() {
  ...
  $(document).on('click', '.btn-remove', function(event) {
    ...
    $.each(inputs, function(item) {
      ...
      /*
      inputs[item].name = 'itemslist[' + Math.floor(item / 6) +'][description]';
            
      if (Math.floor(item / 6) + 0 === 0) {
        console.log(inputs[Math.floor(item / 6) + 0].name);        
      }
      if (Math.floor(item / 6) + 1 === 0) {
      //
      console.log(inputs[Math.floor(item / 6) + 1].name);
      //inputs[Math.floor(item / 6) + 1].name = 'itemslist[' + Math.floor(item / 6) +'][quantity]';
      console.log(inputs[Math.floor(item / 6) + 2].name);
      //inputs[Math.floor(item / 6) + 2].name = 'itemslist[' + Math.floor(item / 6) +'][unitofmeasurment]';
      console.log(inputs[Math.floor(item / 6) + 3].name);
      //inputs[Math.floor(item / 6) + 3].name = 'itemslist[' + Math.floor(item / 6) +'][grossweight]';
      console.log(inputs[Math.floor(item / 6) + 4].name);
      //inputs[Math.floor(item / 6) + 4].name = 'itemslist[' + Math.floor(item / 6) +'][packageweight]';
      console.log(inputs[Math.floor(item / 6) + 5].name);
      //inputs[Math.floor(item / 6) + 5].name = 'itemslist[' + Math.floor(item / 6) +'][netweight]';      */
    });
  });
